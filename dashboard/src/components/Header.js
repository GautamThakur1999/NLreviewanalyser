...
export default function Header() {
  return (
    <header className="fixed top-0 right-0 left-[260px] z-40 bg-surface-bright dark:bg-surface-dim border-b border-outline-variant shadow-sm flex justify-between items-center h-16 px-gutter">
      <div className="flex items-center gap-6">
        <div className="font-headline-md text-headline-md font-bold text-on-surface tracking-tight">Category Discovery Insights</div>
      </div>
